...
export const Layout: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 relative overflow-hidden">
      ...
      <div className="flex flex-col h-screen w-full">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <footer className="text-center py-4 text-white/60 text-sm flex items-center justify-center gap-4">
